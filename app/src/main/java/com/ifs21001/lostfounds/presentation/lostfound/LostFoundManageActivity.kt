package com.ifs21001.lostfounds.presentation.lostfound
...
import com.ifs21001.lostfounds.data.model.LostFound
import com.ifs21001.lostfounds.data.remote.MyResult
import com.ifs21001.lostfounds.databinding.ActivityLostfoundManageBinding
...
import com.ifs21001.lostfounds.helper.getImageUri
import com.ifs21001.lostfounds.helper.reduceFileImage
import com.ifs21001.lostfounds.helper.uriToFile
...
class LostFoundManageActivity : AppCompatActivity() {
    ...
    private fun observePostLostFound(
        title: String,
        description: String,
        status: String) {
        viewModel.postLostFound(
            title,
            description,
            status).observeOnce { result ->
            when (result) {
                is MyResult.Loading -> {
                    showLoading(true)
                }
