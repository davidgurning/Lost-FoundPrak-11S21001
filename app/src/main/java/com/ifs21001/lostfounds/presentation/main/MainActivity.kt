package com.ifs21001.lostfounds.presentation.main
...
import com.ifs21001.lostfounds.R
import com.ifs21001.lostfounds.adapter.LostFoundsAdapter
import com.ifs21001.lostfounds.data.remote.MyResult
import com.ifs21001.lostfounds.databinding.ActivityMainBinding
import com.ifs21001.lostfounds.helper.Utils.Companion.observeOnce
import com.ifs21001.lostfounds.presentation.ViewModelFactory
import com.ifs21001.lostfounds.presentation.login.LoginActivity
import com.ifs21001.lostfounds.presentation.lostfound.LostFoundDetailActivity
import com.ifs21001.lostfounds.presentation.lostfound.LostFoundFavoriteActivity
import com.ifs21001.lostfounds.presentation.lostfound.LostFoundManageActivity
import com.ifs21001.lostfounds.presentation.profile.ProfileActivity
    ...
    private fun setupAction() {
        binding.appbarMain.setOnMenuItemClickListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.mylostfound -> {
                    observeGetAll(null, 1, null)
                    true
                }

                R.id.add_option2 -> {
                    observeGetAll(null, 1, "lost")
                    true
                }

                R.id.add_option3 -> {
                    observeGetAll(null, 1, "found")
                    true
                }
...
//    }
    ...
    private fun observeGetAll(isCompleted: Int? , isMe: Int? ,status:String?) {
