...
import com.ifs21001.lostandfound.databinding.ActivityMainBinding
...
import com.ifs21001.lostandfound.presentation.login.LoginActivity
import com.ifs21001.lostandfound.presentation.profile.ProfileActivity
import com.ifs21001.lostandfound.presentation.lostfound.LostFoundDetailActivity
import com.ifs21001.lostandfound.presentation.lostfound.LostFoundFavoritActivity
import com.ifs21001.lostandfound.presentation.lostfound.LostFoundManageActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadTodosToLayout(response: LostfoundsResponse) {
        ...
        if (lostFounds.isEmpty()) {
            ...
            adapter.setOnItemClickCallback(object : LostFoundAdapter.OnItemClickCallback {
                override fun onCheckedChangeListener(todo: LostFoundsItem, isChecked: Boolean) {
    ...
    private fun openFavoriteTodoActivity() {
        val intent = Intent(
            this@MainActivity,
            LostFoundFavoritActivity::class.java
        )
        launcher.launch(intent)
    }
}