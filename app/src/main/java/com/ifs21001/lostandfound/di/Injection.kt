package com.ifs21001.lostandfound.di

import android.content.Context
import com.ifs21001.lostandfound.data.pref.UserPreference
import com.ifs21001.lostandfound.data.pref.dataStore
import com.ifs21001.lostandfound.data.remote.retrofit.ApiConfig
...
object Injection {
    ...
    fun provideLocalLostFoundRepository(context: Context): LostFoundTodoRepository {
        return LostFoundTodoRepository.getInstance(context)
    }
}